...
const BUILD_MESSAGES = [
  ...
  '🧇 Life moves pretty fast — your app is nearly there',
  ...
  '🏄 No worries, she\'ll be right — app\'s on its way',
  '🥝 Sweet as! Almost ready…',
  '🦘 Your app is hopping right along',
  '🌏 Built with love from the Southern Hemisphere',
]
